...
# Target only Jetson AGX Thor (Blackwell sm_110)
export CUDA_ARCHITECTURES="110"
...
./build.sh --config Release --update --parallel --build --build_wheel --build_shared_lib \
        ...
        --cmake_extra_defines CMAKE_CXX_FLAGS="-Wno-unused-variable -Wno-error=deprecated-declarations -I/usr/local/cuda/include" \
